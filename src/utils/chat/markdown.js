...
const markdown = markdownIt({
  ...
  highlight: function (code, lang) {
    ...
    if (lang && hljs.getLanguage(lang)) {
      try {
        return (
          `<div class="allm-w-full allm-rounded-lg allm-bg-[#1e1e1e] allm-font-['Roboto'] allm-text-sm allm-text-[#d4d4d4] allm-mb-4 allm-relative">
            <div class="allm-absolute allm-top-0 allm-left-0 allm-right-0 allm-flex allm-items-center allm-justify-between allm-px-4 allm-py-1 allm-text-xs allm-bg-[#2d2d2d] allm-rounded-t-lg">
