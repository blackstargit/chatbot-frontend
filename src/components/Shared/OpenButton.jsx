import { Plus, ChatCircleDots, Headset, Binoculars, MagnifyingGlass, MagicWand } from "@phosphor-icons/react";
...
export default function OpenButton({ settings, isOpen, toggleOpen }) {
  ...
  const ChatIcon = CHAT_ICONS.hasOwnProperty(settings?.chatIcon) ? CHAT_ICONS[settings.chatIcon] : CHAT_ICONS.plus;
  return (
    <button
